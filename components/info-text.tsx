    ...
    return (
        <section className="text-center space-y-6 max-w-4xl mb-20 pt-20">
            ...
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9]">
                Pulingizni <br />{" "}
                <span className="text-primary italic">sanashni</span> o'rganing.
            </h1>

            <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-medium leading-relaxed">
                Tiyin — murakkab jadvallardan charchaganlar uchun. Minimalistik
                dizayn, maksimal natija va aqlli tahlil.
            </p>
